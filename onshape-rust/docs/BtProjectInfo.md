...
**permission_scheme** | Option<[**models::BtRbacPermissionSchemeInfo**](BTRbacPermissionSchemeInfo.md)> |  | [optional]
**permission_set** | Option<**Vec<String>**> |  | [optional]
**role_map_entries** | Option<[**Vec<models::RoleMapEntry>**](RoleMapEntry.md)> |  | [optional]
