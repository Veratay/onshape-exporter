...
**defined_by_components** | Option<**bool**> |  | [optional]
**direction_flipped** | Option<**bool**> |  | [optional]
**fgs_base_units** | Option<**String**> |  | [optional]
**load_component_parameter_ids** | Option<**std::collections::HashMap<String, String>**> |  | [optional]
**load_region_parameter_id** | Option<**String**> |  | [optional]
**load_type** | Option<[**models::GbtLoadType**](GBTLoadType.md)> |  | [optional]
**magnitude_parameter_id** | Option<**String**> |  | [optional]
**magnitude_quantity_type** | Option<[**models::GbtQuantityType**](GBTQuantityType.md)> |  | [optional]
**structural_load** | Option<**bool**> |  | [optional]
**suppressed_in_simulations** | Option<**std::collections::HashMap<String, i32>**> |  | [optional]
