...
| LoftConnectionEdgeParameterMismatch | LOFT_CONNECTION_EDGE_PARAMETER_MISMATCH |
| SheetMetalNoConeApex | SHEET_METAL_NO_CONE_APEX |
| SimulationMaterialPropertyOutsideRequiredBounds | SIMULATION_MATERIAL_PROPERTY_OUTSIDE_REQUIRED_BOUNDS |
| FgsConnectionsAssemblyTooComplex | FGS_CONNECTIONS_ASSEMBLY_TOO_COMPLEX |
| Unknown | UNKNOWN |
