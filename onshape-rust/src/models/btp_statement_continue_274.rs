...
pub struct BtpStatementContinue274 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterContinue", skip_serializing_if = "Option::is_none")]
    pub space_after_continue: Option<Box<models::BtpSpace10>>,
}

impl BtpStatementContinue274 {
    pub fn new() -> BtpStatementContinue274 {
