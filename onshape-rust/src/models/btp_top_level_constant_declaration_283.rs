...
pub struct BtpTopLevelConstantDeclaration283 {
    /// Type of JSON object.
    ...
    pub declaration: Option<Box<models::BtpStatementConstantDeclaration273>>,
}

impl BtpTopLevelConstantDeclaration283 {
    pub fn new() -> BtpTopLevelConstantDeclaration283 {
