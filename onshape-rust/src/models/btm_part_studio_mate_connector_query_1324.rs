...
pub struct BtmPartStudioMateConnectorQuery1324 {
    /// Type of JSON object.
    ...
    pub feature_id_with_occurrence: Option<String>,
    #[serde(rename = "partStudioMateConnectorQuery", skip_serializing_if = "Option::is_none")]
    pub part_studio_mate_connector_query: Option<bool>,
    #[serde(rename = "queryData", skip_serializing_if = "Option::is_none")]
    pub query_data: Option<String>,
}

impl BtmPartStudioMateConnectorQuery1324 {
    pub fn new() -> BtmPartStudioMateConnectorQuery1324 {
        BtmPartStudioMateConnectorQuery1324 {
            ...
            path: None,
            feature_id: None,
            feature_id_with_occurrence: None,
            part_studio_mate_connector_query: None,
            query_data: None,
        }
    }
}
