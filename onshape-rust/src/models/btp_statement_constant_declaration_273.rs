...
pub struct BtpStatementConstantDeclaration273 {
    /// Type of JSON object.
    ...
    pub r#type: Option<Box<models::BtpTypeName290>>,
    #[serde(rename = "typeName", skip_serializing_if = "Option::is_none")]
    pub type_name: Option<String>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::BtpExpression9>>,
}

impl BtpStatementConstantDeclaration273 {
    pub fn new() -> BtpStatementConstantDeclaration273 {
