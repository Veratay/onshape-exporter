...
pub struct BtpStatementLoopFor3278 {
    /// Type of JSON object.
    ...
    pub increment: Option<Box<models::BtpStatement269>>,
    #[serde(rename = "initialization", skip_serializing_if = "Option::is_none")]
    pub initialization: Option<Box<models::BtpStatement269>>,
    #[serde(rename = "spaceAfterInitialization", skip_serializing_if = "Option::is_none")]
    pub space_after_initialization: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "spaceBeforeCondition", skip_serializing_if = "Option::is_none")]
    pub space_before_condition: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "spaceBeforeIncrement", skip_serializing_if = "Option::is_none")]
    pub space_before_increment: Option<Box<models::BtpSpace10>>,
}

impl BtpStatementLoopFor3278 {
    pub fn new() -> BtpStatementLoopFor3278 {
        BtpStatementLoopFor3278 {
            ...
            increment: None,
            initialization: None,
            space_after_initialization: None,
            space_before_condition: None,
            space_before_increment: None,
        }
    }
}
