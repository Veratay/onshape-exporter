...
pub struct BtParameterSpecNullableQuantity715 {
    /// Type of JSON object.
    ...
    pub ranges: Option<Vec<models::BtNullableQuantityRange1340>>,
}

impl BtParameterSpecNullableQuantity715 {
    pub fn new() -> BtParameterSpecNullableQuantity715 {
