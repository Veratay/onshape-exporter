...
pub struct BtmConfiguredValueByBoolean1501 {
    /// Type of JSON object.
    ...
    pub value: Option<Box<models::BtmParameter1>>,
    #[serde(rename = "booleanValue", skip_serializing_if = "Option::is_none")]
    pub boolean_value: Option<bool>,
}

impl BtmConfiguredValueByBoolean1501 {
    pub fn new() -> BtmConfiguredValueByBoolean1501 {
