...
pub struct BtClonedInstance2505 {
    /// Type of JSON object.
    ...
    #[serde(rename = "seedOccurrence", skip_serializing_if = "Option::is_none")]
    pub seed_occurrence: Option<Box<models::BtOccurrence74>>,
}

impl BtClonedInstance2505 {
    pub fn new() -> BtClonedInstance2505 {
