...
pub struct BtParametricPartStudioInstance4374 {
    /// Type of JSON object.
    ...
    #[serde(rename = "parametricPartStudioFeature", skip_serializing_if = "Option::is_none")]
    pub parametric_part_studio_feature: Option<Box<models::BtmParametricPartStudioFeature3883>>,
    #[serde(rename = "referenceParameter", skip_serializing_if = "Option::is_none")]
    pub reference_parameter: Option<Box<models::BtmParameterReferencePartStudio3302>>,
...
impl BtParametricPartStudioInstance4374 {
    pub fn new() -> BtParametricPartStudioInstance4374 {
        BtParametricPartStudioInstance4374 {
            ...
            parametric_part_studio_feature: None,
