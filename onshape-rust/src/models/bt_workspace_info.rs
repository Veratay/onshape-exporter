...
pub struct BtWorkspaceInfo {
    ...
    pub parents: Option<Vec<models::BtVersionInfo>>,
    #[serde(rename = "protectionRule", skip_serializing_if = "Option::is_none")]
    pub protection_rule: Option<models::BtWorkspaceProtectionRuleOptions>,
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<models::BtObjectState>,
