...
pub struct BtPartInstance81 {
    ...
    pub locked_state: Option<Box<models::BtmParameter1>>,
    ...
    #[serde(rename = "partReference", skip_serializing_if = "Option::is_none")]
    pub part_reference: Option<Box<models::BtmParameterReferencePartStudio3302>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<models::GbtPartStudioInstanceType>,
}

impl BtPartInstance81 {
    pub fn new() -> BtPartInstance81 {
        BtPartInstance81 {
            bt_type: None,
