...
pub struct BtDisplayStateInfo {
    ...
    #[serde(rename = "isOnshapeDefault", skip_serializing_if = "Option::is_none")]
    pub is_onshape_default: Option<bool>,
    /// The name of the view feature.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}

impl BtDisplayStateInfo {
    /// Describes a display state.
    pub fn new() -> BtDisplayStateInfo {
        BtDisplayStateInfo {
            id: None,
            is_onshape_default: None,
            name: None,
        }
    }
}
