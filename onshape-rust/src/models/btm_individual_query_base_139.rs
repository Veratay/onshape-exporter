...
#[serde(tag = "btType")]
pub enum BtmIndividualQueryBase139 {
    #[serde(rename="BTMInContextQuery-2254")]
    ...
    #[serde(rename="BTMIndividualQuery-138")]
    ...
    #[serde(rename="BTMIndividualQueryWithOccurrenceBase-904")]
...
impl Default for BtmIndividualQueryBase139 {
    fn default() -> Self {
        Self::BtminContextQuery2254 {
