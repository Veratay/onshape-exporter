...
pub struct BtAssemblyPattern1974 {
    /// Type of JSON object.
    ...
    #[serde(rename = "patternFeature", skip_serializing_if = "Option::is_none")]
    pub pattern_feature: Option<Box<models::BtmAssemblyPatternFeature2241>>,
}

impl BtAssemblyPattern1974 {
    pub fn new() -> BtAssemblyPattern1974 {
