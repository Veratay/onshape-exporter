...
pub struct BtpStatementBlock271 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterOpen", skip_serializing_if = "Option::is_none")]
    pub space_after_open: Option<Box<models::BtpSpace10>>,
}

impl BtpStatementBlock271 {
    pub fn new() -> BtpStatementBlock271 {
