...
pub struct BtParameterSpecIcon4779 {
    /// Type of JSON object.
    ...
    #[serde(rename = "allowLink", skip_serializing_if = "Option::is_none")]
    pub allow_link: Option<bool>,
}

impl BtParameterSpecIcon4779 {
    pub fn new() -> BtParameterSpecIcon4779 {
