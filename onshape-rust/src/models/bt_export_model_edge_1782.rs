...
pub struct BtExportModelEdge1782 {
    /// Type of JSON object.
    ...
    pub curve: Option<Box<models::BtCurveDescription1583>>,
    #[serde(rename = "geometry", skip_serializing_if = "Option::is_none")]
    pub geometry: Option<Box<models::BtExportModelEdgeGeometry1125>>,
...
impl BtExportModelEdge1782 {
    pub fn new() -> BtExportModelEdge1782 {
