...
pub struct BtParameterSpecCategories4083 {
    /// Type of JSON object.
    ...
    pub enum_value_to_visibility_condition: Option<std::collections::HashMap<String, models::BtParameterVisibilityCondition177>>,
    ...
    pub option_names: Option<Vec<String>>,
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<String>>,
    #[serde(rename = "categoryIdToMetadataTypes", skip_serializing_if = "Option::is_none")]
    pub category_id_to_metadata_types: Option<std::collections::HashMap<String, Vec<i32>>>,
}

impl BtParameterSpecCategories4083 {
    pub fn new() -> BtParameterSpecCategories4083 {
        BtParameterSpecCategories4083 {
            ...
            enum_name: None,
            enum_value_to_visibility_condition: None,
            multivalued: None,
            namespace: None,
            option_names: None,
            options: None,
            category_id_to_metadata_types: None,
        }
    }
}
