...
pub struct BtNamedPositionValuesColumnInfo816 {
    /// Type of JSON object.
    ...
    #[serde(rename = "columnHasError", skip_serializing_if = "Option::is_none")]
    pub column_has_error: Option<bool>,
...
impl BtNamedPositionValuesColumnInfo816 {
    pub fn new() -> BtNamedPositionValuesColumnInfo816 {
        BtNamedPositionValuesColumnInfo816 {
            bt_type: None,
            id: None,
            node_id: None,
            specification: None,
            column_has_error: None,
            parameter_id: None,
            parent_id: None,
            parent_name: None,
            tooltip: None,
