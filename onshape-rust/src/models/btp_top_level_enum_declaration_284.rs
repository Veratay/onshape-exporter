...
pub struct BtpTopLevelEnumDeclaration284 {
    /// Type of JSON object.
    ...
    pub annotations: Option<Vec<models::BtpAnnotation231>>,
    #[serde(rename = "spaceInEmptyList", skip_serializing_if = "Option::is_none")]
    pub space_in_empty_list: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "trailingComma", skip_serializing_if = "Option::is_none")]
    pub trailing_comma: Option<bool>,
    #[serde(rename = "values", skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<models::BtpIdentifier8>>,
}

impl BtpTopLevelEnumDeclaration284 {
    pub fn new() -> BtpTopLevelEnumDeclaration284 {
