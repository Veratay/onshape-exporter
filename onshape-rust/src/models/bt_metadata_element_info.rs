...
pub struct BtMetadataElementInfo {
    ...
    pub parts: Option<Box<models::BtMetadataObjectListInfoBtMetadataPartInfo>>,
}

impl BtMetadataElementInfo {
    pub fn new(json_type: String) -> BtMetadataElementInfo {
