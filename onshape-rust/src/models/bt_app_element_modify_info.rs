...
pub struct BtAppElementModifyInfo {
    ...
    #[serde(rename = "jsonDifference", skip_serializing_if = "Option::is_none")]
    pub json_difference: Option<Box<models::BtDiffJsonResponse2725>>,
...
impl BtAppElementModifyInfo {
    pub fn new(change_id: String) -> BtAppElementModifyInfo {
