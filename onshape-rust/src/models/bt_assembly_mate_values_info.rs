...
pub struct BtAssemblyMateValuesInfo {
    ...
    #[serde(rename = "mateValues", skip_serializing_if = "Option::is_none")]
    pub mate_values: Option<Vec<models::BtAssemblyMateValueInfo>>,
}

impl BtAssemblyMateValuesInfo {
    /// Get a list of mate values for all the mates of a specified assembly.
    pub fn new() -> BtAssemblyMateValuesInfo {
