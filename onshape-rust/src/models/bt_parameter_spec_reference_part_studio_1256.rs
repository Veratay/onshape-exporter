...
pub struct BtParameterSpecReferencePartStudio1256 {
    /// Type of JSON object.
    ...
    #[serde(rename = "allowedInsertableTypes", skip_serializing_if = "Option::is_none")]
    pub allowed_insertable_types: Option<Vec<models::GbtPartStudioItemType>>,
    #[serde(rename = "computedConfigurationInputs", skip_serializing_if = "Option::is_none")]
    pub computed_configuration_inputs: Option<Vec<models::BtComputedConfigurationInputSpec2525>>,
    #[serde(rename = "maxNumberOfPicks", skip_serializing_if = "Option::is_none")]
    pub max_number_of_picks: Option<i32>,
}

impl BtParameterSpecReferencePartStudio1256 {
    pub fn new() -> BtParameterSpecReferencePartStudio1256 {
        BtParameterSpecReferencePartStudio1256 {
            ...
            allowed_insertable_types: None,
            computed_configuration_inputs: None,
            max_number_of_picks: None,
        }
    }
}
