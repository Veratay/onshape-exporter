...
pub struct BtpTopLevelUserTypeDeclaration288 {
    /// Type of JSON object.
    ...
    #[serde(rename = "typecheck", skip_serializing_if = "Option::is_none")]
    pub typecheck: Option<Box<models::BtpName261>>,
}

impl BtpTopLevelUserTypeDeclaration288 {
    pub fn new() -> BtpTopLevelUserTypeDeclaration288 {
