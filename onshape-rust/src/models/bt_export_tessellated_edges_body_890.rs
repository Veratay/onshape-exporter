...
pub struct BtExportTessellatedEdgesBody890 {
    /// Type of JSON object.
    ...
    pub edges: Option<Vec<models::BtExportTessellatedEdgesEdge1364>>,
}

impl BtExportTessellatedEdgesBody890 {
    pub fn new() -> BtExportTessellatedEdgesBody890 {
