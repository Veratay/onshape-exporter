...
pub struct BtProjectInfo {
    ...
    pub permission_scheme: Option<Box<models::BtRbacPermissionSchemeInfo>>,
    ...
    pub role_map_entries: Option<Vec<models::RoleMapEntry>>,
    #[serde(rename = "trash", skip_serializing_if = "Option::is_none")]
    pub trash: Option<bool>,
}

impl BtProjectInfo {
    pub fn new(json_type: String) -> BtProjectInfo {
        BtProjectInfo {
            can_move: None,
            created_at: None,
            created_by: None,
