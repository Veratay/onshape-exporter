...
#[serde(tag = "btType")]
pub enum BtpTopLevelNode286 {
    #[serde(rename="BTPProcedureDeclarationBase-266")]
    ...
    #[serde(rename="BTPTopLevelConstantDeclaration-283")]
    ...
    #[serde(rename="BTPTopLevelImport-285")]
    ...
    #[serde(rename="BTPTopLevelTypeDeclaration-287")]
...
impl Default for BtpTopLevelNode286 {
    fn default() -> Self {
        Self::BtpProcedureDeclarationBase266 {
