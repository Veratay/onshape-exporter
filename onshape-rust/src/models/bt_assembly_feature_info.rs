...
pub struct BtAssemblyFeatureInfo {
    #[serde(rename = "featureData", skip_serializing_if = "Option::is_none")]
    pub feature_data: Option<Box<models::BtAssemblyFeatureDataInfo>>,
