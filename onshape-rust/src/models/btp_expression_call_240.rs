...
pub struct BtpExpressionCall240 {
    /// Type of JSON object.
    ...
    #[serde(rename = "functionExpression", skip_serializing_if = "Option::is_none")]
    pub function_expression: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "functionName", skip_serializing_if = "Option::is_none")]
    pub function_name: Option<Box<models::BtpName261>>,
    #[serde(rename = "functionNameString", skip_serializing_if = "Option::is_none")]
    pub function_name_string: Option<String>,
    #[serde(rename = "isArrowCall", skip_serializing_if = "Option::is_none")]
    pub is_arrow_call: Option<bool>,
    #[serde(rename = "spaceInEmptyList", skip_serializing_if = "Option::is_none")]
    pub space_in_empty_list: Option<Box<models::BtpSpace10>>,
}

impl BtpExpressionCall240 {
    pub fn new() -> BtpExpressionCall240 {
