...
#[serde(tag = "btType")]
pub enum BtpStatementLoop277 {
    #[serde(rename="BTPStatementLoopFor3-278")]
    BtpStatementLoopFor3278 {
        ...
        body: Option<Box<models::BtpStatement269>>,
        #[serde(rename = "spaceAfterLoopType", skip_serializing_if = "Option::is_none")]
        space_after_loop_type: Option<Box<models::BtpSpace10>>,
    },
    #[serde(rename="BTPStatementLoopForIn-279")]
    ...
    #[serde(rename="BTPStatementLoopWhile-280")]
...
impl Default for BtpStatementLoop277 {
    fn default() -> Self {
        Self::BtpStatementLoopFor3278 {
            ...
            space_after_loop_type: Default::default(),
        }
