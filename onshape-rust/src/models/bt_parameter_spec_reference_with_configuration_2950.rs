...
pub struct BtParameterSpecReferenceWithConfiguration2950 {
    /// Type of JSON object.
    ...
    #[serde(rename = "allowAssemblies", skip_serializing_if = "Option::is_none")]
    pub allow_assemblies: Option<bool>,
...
impl BtParameterSpecReferenceWithConfiguration2950 {
    pub fn new() -> BtParameterSpecReferenceWithConfiguration2950 {
