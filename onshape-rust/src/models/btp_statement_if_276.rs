...
pub struct BtpStatementIf276 {
    ...
    pub else_body: Option<Box<models::BtpStatement269>>,
    #[serde(rename = "spaceAfterIf", skip_serializing_if = "Option::is_none")]
    pub space_after_if: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "thenBody", skip_serializing_if = "Option::is_none")]
    pub then_body: Option<Box<models::BtpStatement269>>,
}

impl BtpStatementIf276 {
    pub fn new() -> BtpStatementIf276 {
        BtpStatementIf276 {
            bt_type: None,
            atomic: None,
