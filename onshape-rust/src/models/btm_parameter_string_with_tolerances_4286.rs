...
pub struct BtmParameterStringWithTolerances4286 {
    /// Type of JSON object.
    ...
    pub components: Option<Vec<models::BtToleranceString3274>>,
}

impl BtmParameterStringWithTolerances4286 {
    pub fn new() -> BtmParameterStringWithTolerances4286 {
