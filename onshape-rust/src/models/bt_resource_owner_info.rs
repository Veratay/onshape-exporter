...
pub struct BtResourceOwnerInfo {
    ...
    #[serde(rename = "isEnterpriseEdu", skip_serializing_if = "Option::is_none")]
    pub is_enterprise_edu: Option<bool>,
    #[serde(rename = "state", skip_serializing_if = "Option::is_none")]
    pub state: Option<i32>,
}

impl BtResourceOwnerInfo {
    pub fn new(json_type: String) -> BtResourceOwnerInfo {
        BtResourceOwnerInfo {
            can_move: None,
            created_at: None,
            created_by: None,
