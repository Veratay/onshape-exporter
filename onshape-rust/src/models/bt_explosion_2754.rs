...
pub struct BtExplosion2754 {
    ...
    #[serde(rename = "explodeSteps", skip_serializing_if = "Option::is_none")]
    pub explode_steps: Option<Vec<models::BtExplosionStepFeature3008>>,
    #[serde(rename = "startingPositionId", skip_serializing_if = "Option::is_none")]
    pub starting_position_id: Option<Box<models::BtMicroversionIdAndConfiguration2338>>,
}

impl BtExplosion2754 {
    pub fn new() -> BtExplosion2754 {
        BtExplosion2754 {
            bt_type: None,
            feature_id: None,
            feature_type: None,
