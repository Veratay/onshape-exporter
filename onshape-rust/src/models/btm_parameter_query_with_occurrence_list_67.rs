...
pub struct BtmParameterQueryWithOccurrenceList67 {
    /// Type of JSON object.
    ...
    pub queries: Option<Vec<models::BtmIndividualQueryWithOccurrenceBase904>>,
}

impl BtmParameterQueryWithOccurrenceList67 {
    pub fn new() -> BtmParameterQueryWithOccurrenceList67 {
