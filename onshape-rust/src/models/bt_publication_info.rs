...
pub struct BtPublicationInfo {
    ...
    #[serde(rename = "defaultWorkspaceId", skip_serializing_if = "Option::is_none")]
...
impl BtPublicationInfo {
    pub fn new(json_type: String) -> BtPublicationInfo {
        BtPublicationInfo {
            can_move: None,
            created_at: None,
            created_by: None,
