...
pub struct BtAppArrayInfoBtAppDrawingViewInfo {
    ...
    pub items: Option<Vec<models::BtAppDrawingViewInfo>>,
    #[serde(rename = "parentChangeId", skip_serializing_if = "Option::is_none")]
    pub parent_change_id: Option<String>,
}

impl BtAppArrayInfoBtAppDrawingViewInfo {
    pub fn new() -> BtAppArrayInfoBtAppDrawingViewInfo {
