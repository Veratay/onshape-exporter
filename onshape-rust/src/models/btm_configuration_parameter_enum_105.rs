...
pub struct BtmConfigurationParameterEnum105 {
    /// Type of JSON object.
    ...
    #[serde(rename = "enumOptionVisibilityConditions", skip_serializing_if = "Option::is_none")]
    pub enum_option_visibility_conditions: Option<Box<models::BtEnumOptionVisibilityConditionList2936>>,
    #[serde(rename = "namespace", skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
    #[serde(rename = "optionIds", skip_serializing_if = "Option::is_none")]
    pub option_ids: Option<Vec<String>>,
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<models::BtmEnumOption592>>,
}

impl BtmConfigurationParameterEnum105 {
    pub fn new() -> BtmConfigurationParameterEnum105 {
        BtmConfigurationParameterEnum105 {
            ...
            default_value: None,
            enum_name: None,
            enum_option_visibility_conditions: None,
            namespace: None,
            option_ids: None,
            options: None,
        }
