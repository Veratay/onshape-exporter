...
pub struct BtpExpressionBuiltinCall239 {
    /// Type of JSON object.
    ...
    pub arguments: Option<Vec<models::BtpExpression9>>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<Box<models::BtpBuiltinIdentifier233>>,
    #[serde(rename = "spaceInEmptyList", skip_serializing_if = "Option::is_none")]
    pub space_in_empty_list: Option<Box<models::BtpSpace10>>,
}

impl BtpExpressionBuiltinCall239 {
    pub fn new() -> BtpExpressionBuiltinCall239 {
