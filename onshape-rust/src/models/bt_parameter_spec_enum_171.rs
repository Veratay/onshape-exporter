...
pub struct BtParameterSpecEnum171 {
    /// Type of JSON object.
    ...
    #[serde(rename = "optionIconUris", skip_serializing_if = "Option::is_none")]
    pub option_icon_uris: Option<Vec<String>>,
...
impl BtParameterSpecEnum171 {
    pub fn new() -> BtParameterSpecEnum171 {
