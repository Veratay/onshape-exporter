...
pub struct BtmParameterBlobReference1679 {
    /// Type of JSON object.
    ...
    #[serde(rename = "blobImport", skip_serializing_if = "Option::is_none")]
    pub blob_import: Option<Box<models::BtmImport136>>,
    #[serde(rename = "namespace", skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
}

impl BtmParameterBlobReference1679 {
    pub fn new() -> BtmParameterBlobReference1679 {
