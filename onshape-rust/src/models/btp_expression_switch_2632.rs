...
pub struct BtpExpressionSwitch2632 {
    /// Type of JSON object.
    ...
    pub choices: Option<Box<models::BtpLiteralMap256>>,
    #[serde(rename = "selector", skip_serializing_if = "Option::is_none")]
    pub selector: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "spaceAfterSwitch", skip_serializing_if = "Option::is_none")]
    pub space_after_switch: Option<Box<models::BtpSpace10>>,
}

impl BtpExpressionSwitch2632 {
    pub fn new() -> BtpExpressionSwitch2632 {
