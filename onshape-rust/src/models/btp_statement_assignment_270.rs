...
pub struct BtpStatementAssignment270 {
    /// Type of JSON object.
    ...
    #[serde(rename = "lvalue", skip_serializing_if = "Option::is_none")]
    pub lvalue: Option<Box<models::BtplValue249>>,
    #[serde(rename = "operator", skip_serializing_if = "Option::is_none")]
    pub operator: Option<models::GbtpOperator>,
    #[serde(rename = "rvalue", skip_serializing_if = "Option::is_none")]
    pub rvalue: Option<Box<models::BtpExpression9>>,
}

impl BtpStatementAssignment270 {
    pub fn new() -> BtpStatementAssignment270 {
