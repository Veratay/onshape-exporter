...
pub struct BtFeatureSpecsResponse664 {
    /// Type of JSON object.
    #[serde(rename = "btType", skip_serializing_if = "Option::is_none")]
    pub bt_type: Option<String>,
    #[serde(rename = "featureSpecs", skip_serializing_if = "Option::is_none")]
    pub feature_specs: Option<Vec<models::BtFeatureSpec129>>,
...
impl BtFeatureSpecsResponse664 {
    pub fn new() -> BtFeatureSpecsResponse664 {
