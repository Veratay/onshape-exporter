...
pub struct BtpStatementLoopForIn279 {
    /// Type of JSON object.
    ...
    pub container: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "identifiers", skip_serializing_if = "Option::is_none")]
    pub identifiers: Option<Vec<models::BtpIdentifier8>>,
    #[serde(rename = "isVarDeclaredHere", skip_serializing_if = "Option::is_none")]
    pub is_var_declared_here: Option<bool>,
    #[serde(rename = "keyVar", skip_serializing_if = "Option::is_none")]
    pub key_var: Option<Box<models::BtpIdentifier8>>,
    #[serde(rename = "spaceBeforeVar", skip_serializing_if = "Option::is_none")]
    pub space_before_var: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "standardTypes", skip_serializing_if = "Option::is_none")]
    pub standard_types: Option<Vec<models::GbtpType>>,
    #[serde(rename = "typeNames", skip_serializing_if = "Option::is_none")]
    pub type_names: Option<Vec<String>>,
    #[serde(rename = "var", skip_serializing_if = "Option::is_none")]
    pub var: Option<Box<models::BtpIdentifier8>>,
}

impl BtpStatementLoopForIn279 {
    pub fn new() -> BtpStatementLoopForIn279 {
        BtpStatementLoopForIn279 {
            ...
            container: None,
            identifiers: None,
            is_var_declared_here: None,
            key_var: None,
            space_before_var: None,
            standard_types: None,
            type_names: None,
            var: None,
        }
