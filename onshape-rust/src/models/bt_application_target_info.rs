...
pub struct BtApplicationTargetInfo {
    ...
    #[serde(rename = "tabIconHref", skip_serializing_if = "Option::is_none")]
    pub tab_icon_href: Option<String>,
}

impl BtApplicationTargetInfo {
    pub fn new() -> BtApplicationTargetInfo {
