...
pub struct BtRootDiffInfo {
    ...
    pub changes: Option<std::collections::HashMap<String, models::BtDiffInfo>>,
    #[serde(rename = "collectionChanges", skip_serializing_if = "Option::is_none")]
    pub collection_changes: Option<std::collections::HashMap<String, Vec<models::BtDiffInfo>>>,
    #[serde(rename = "entityType", skip_serializing_if = "Option::is_none")]
    pub entity_type: Option<models::BtDiffInfoCollectionType>,
    ...
    pub r#type: Option<models::GbtNodeChange>,
}
