...
pub struct BtNullableQuantityRange1340 {
    /// Type of JSON object.
    ...
    pub location: Option<Box<models::BtLocationInfo226>>,
    ...
    #[serde(rename = "hasMaxValue", skip_serializing_if = "Option::is_none")]
    pub has_max_value: Option<bool>,
    #[serde(rename = "hasMinValue", skip_serializing_if = "Option::is_none")]
    pub has_min_value: Option<bool>,
}

impl BtNullableQuantityRange1340 {
    pub fn new() -> BtNullableQuantityRange1340 {
