...
pub struct BtmMateConnector66 {
    ...
    #[serde(rename = "isAuxiliaryTreeMateConnector", skip_serializing_if = "Option::is_none")]
    pub is_auxiliary_tree_mate_connector: Option<bool>,
    #[serde(rename = "isHidden", skip_serializing_if = "Option::is_none")]
    pub is_hidden: Option<bool>,
    #[serde(rename = "savedFeatureType", skip_serializing_if = "Option::is_none")]
    pub saved_feature_type: Option<String>,
}

impl BtmMateConnector66 {
    pub fn new() -> BtmMateConnector66 {
        BtmMateConnector66 {
            bt_type: None,
            feature_id: None,
            feature_type: None,
            ...
            version: None,
            implicit: None,
            is_auxiliary_tree_mate_connector: None,
            is_hidden: None,
            saved_feature_type: None,
        }
    }
}
