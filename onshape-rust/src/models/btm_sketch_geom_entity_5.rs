...
#[serde(tag = "btType")]
pub enum BtmSketchGeomEntity5 {
    #[serde(rename="BTMSketchCurve-4")]
    BtmSketchCurve4 {
    ...
    #[serde(rename="BTMSketchImageEntity-763")]
    ...
    #[serde(rename="BTMSketchPoint-158")]
    BtmSketchPoint158 {
        /// Element microversion that is being imported.
        #[serde(rename = "importMicroversion", skip_serializing_if = "Option::is_none")]
        import_microversion: Option<String>,
    ...
    #[serde(rename="BTMSketchTextEntity-1761")]
...
impl Default for BtmSketchGeomEntity5 {
    fn default() -> Self {
        Self::BtmSketchCurve4 {
