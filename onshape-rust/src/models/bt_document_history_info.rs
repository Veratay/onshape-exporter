...
pub struct BtDocumentHistoryInfo {
    #[serde(rename = "canBeRestored", skip_serializing_if = "Option::is_none")]
    pub can_be_restored: Option<bool>,
    ...
    #[serde(rename = "nextMicroversionId", skip_serializing_if = "Option::is_none")]
    pub next_microversion_id: Option<String>,
...
impl BtDocumentHistoryInfo {
    pub fn new() -> BtDocumentHistoryInfo {
        BtDocumentHistoryInfo {
            can_be_restored: None,
            date: None,
            description: None,
            microversion_id: None,
            next_microversion_id: None,
            restore_id: None,
            user_id: None,
            username: None,
        }
