...
pub struct Schema {
    ...
    pub dependent_schemas: Option<std::collections::HashMap<String, models::Schema>>,
    ...
    pub pattern_properties: Option<std::collections::HashMap<String, models::Schema>>,
    #[serde(rename = "prefixItems", skip_serializing_if = "Option::is_none")]
    pub prefix_items: Option<Vec<models::Schema>>,
    #[serde(rename = "properties", skip_serializing_if = "Option::is_none")]
    pub properties: Option<std::collections::HashMap<String, models::Schema>>,
