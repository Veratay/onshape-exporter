...
#[serde(tag = "btType")]
pub enum BtParametricInstance2641 {
    #[serde(rename="BTAssemblyMirror-2996")]
    BtAssemblyMirror2996 {
        ...
        feature: Option<Box<models::BtmAssemblyFeature887>>,
        ...
        instance_control_nodes: Option<Vec<models::BtInstanceControlNode750>>,
        #[serde(rename = "seedBasedParametricInstance", skip_serializing_if = "Option::is_none")]
        seed_based_parametric_instance: Option<bool>,
    },
    #[serde(rename="BTAssemblyPattern-1974")]
    ...
    #[serde(rename="BTAssemblyReplicate-2774")]
    ...
    #[serde(rename="BTDerivedAssemblyMirror-4204")]
    ...
    #[serde(rename="BTParametricPartStudioInstance-4374")]
...
impl Default for BtParametricInstance2641 {
    fn default() -> Self {
        Self::BtAssemblyMirror2996 {
            ...
            instance_control_nodes: Default::default(),
            seed_based_parametric_instance: Default::default(),
        }
