...
pub struct BtRadialDimensionDisplayData348 {
    /// Type of JSON object.
    ...
    #[serde(rename = "radiusDisplay", skip_serializing_if = "Option::is_none")]
    pub radius_display: Option<models::GbtRadiusDisplay>,
    #[serde(rename = "realDiameter", skip_serializing_if = "Option::is_none")]
    pub real_diameter: Option<bool>,
...
impl BtRadialDimensionDisplayData348 {
    pub fn new() -> BtRadialDimensionDisplayData348 {
