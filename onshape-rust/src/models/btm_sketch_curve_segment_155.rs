...
pub struct BtmSketchCurveSegment155 {
    /// Type of JSON object.
    ...
    pub internal_ids: Option<Vec<String>>,
    #[serde(rename = "endParam", skip_serializing_if = "Option::is_none")]
    pub end_param: Option<f64>,
    #[serde(rename = "endPointId", skip_serializing_if = "Option::is_none")]
    pub end_point_id: Option<String>,
    #[serde(rename = "offsetCurveExtensions", skip_serializing_if = "Option::is_none")]
    pub offset_curve_extensions: Option<Vec<f64>>,
    #[serde(rename = "startParam", skip_serializing_if = "Option::is_none")]
    pub start_param: Option<f64>,
    #[serde(rename = "startPointId", skip_serializing_if = "Option::is_none")]
    pub start_point_id: Option<String>,
}

impl BtmSketchCurveSegment155 {
    pub fn new() -> BtmSketchCurveSegment155 {
