...
pub struct BtCategoryPropertyInfo {
    ...
    #[serde(rename = "categoryPropertyConfigInfo", skip_serializing_if = "Option::is_none")]
    pub category_property_config_info: Option<Box<models::BtCategoryPropertyConfigInfo>>,
    #[serde(rename = "categorySummaryInfoList", skip_serializing_if = "Option::is_none")]
    pub category_summary_info_list: Option<Vec<models::BtMetadataCategorySummaryInfo>>,
...
impl BtCategoryPropertyInfo {
    pub fn new() -> BtCategoryPropertyInfo {
        BtCategoryPropertyInfo {
            array: None,
            assignable: None,
            blob_mime_type: None,
            category_property_config_info: None,
            category_summary_info_list: None,
            description: None,
