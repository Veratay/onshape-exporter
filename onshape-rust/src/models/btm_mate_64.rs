...
pub struct BtmMate64 {
    ...
    #[serde(rename = "mateConnectorQueryList", skip_serializing_if = "Option::is_none")]
    pub mate_connector_query_list: Option<Box<models::BtmParameterQueryWithOccurrenceList67>>,
    #[serde(rename = "mateType", skip_serializing_if = "Option::is_none")]
    pub mate_type: Option<models::GbtMateType>,
}

impl BtmMate64 {
    pub fn new() -> BtmMate64 {
        BtmMate64 {
            bt_type: None,
            feature_id: None,
            feature_type: None,
            ...
            version: None,
            mate_connector_query_list: None,
            mate_type: None,
        }
    }
}
