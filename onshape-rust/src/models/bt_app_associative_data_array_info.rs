...
pub struct BtAppAssociativeDataArrayInfo {
    ...
    pub items: Option<Vec<models::BtAssociativeDataInfo>>,
    #[serde(rename = "parentChangeId", skip_serializing_if = "Option::is_none")]
    pub parent_change_id: Option<String>,
}

impl BtAppAssociativeDataArrayInfo {
    pub fn new() -> BtAppAssociativeDataArrayInfo {
