...
pub struct BtTableSpec915 {
    ...
    #[serde(rename = "computedPropertyCategoryIds", skip_serializing_if = "Option::is_none")]
    pub computed_property_category_ids: Option<Vec<String>>,
    #[serde(rename = "defaultPartCategoryId", skip_serializing_if = "Option::is_none")]
    pub default_part_category_id: Option<String>,
    #[serde(rename = "isComputedPropertyTable", skip_serializing_if = "Option::is_none")]
    pub is_computed_property_table: Option<bool>,
}

impl BtTableSpec915 {
    pub fn new() -> BtTableSpec915 {
        BtTableSpec915 {
            bt_type: None,
            ...
            computed_property_category_ids: None,
            default_part_category_id: None,
            is_computed_property_table: None,
        }
    }
}
