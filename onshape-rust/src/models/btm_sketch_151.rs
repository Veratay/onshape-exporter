...
pub struct BtmSketch151 {
    ...
    pub constraints: Option<Vec<models::BtmSketchConstraint2>>,
    #[serde(rename = "entities", skip_serializing_if = "Option::is_none")]
    pub entities: Option<Vec<models::BtmSketchGeomEntity5>>,
}

impl BtmSketch151 {
    pub fn new() -> BtmSketch151 {
        BtmSketch151 {
            bt_type: None,
            feature_id: None,
            feature_type: None,
