...
pub struct BtFeatureScriptEvalResponse1859 {
    /// Type of JSON object.
    ...
    pub notices: Option<Vec<models::BtNotice227>>,
    ...
    pub result: Option<Box<models::BtfsValue1888>>,
...
impl BtFeatureScriptEvalResponse1859 {
    pub fn new() -> BtFeatureScriptEvalResponse1859 {
