...
/// BtListResponseBtTeamMemberInfo : A list of resources that typically supports paging.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BtListResponseBtTeamMemberInfo {
    /// URI for current page of resources.
    #[serde(rename = "href", skip_serializing_if = "Option::is_none")]
    pub href: Option<String>,
    /// Array of items in the current page.
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<models::BtTeamMemberInfo>>,
...
impl BtListResponseBtTeamMemberInfo {
    /// A list of resources that typically supports paging.
    pub fn new() -> BtListResponseBtTeamMemberInfo {
