...
pub struct BtmAssemblyPatternFeature2241 {
    ...
    pub pattern_type: Option<models::GbtPatternType>,
...
impl BtmAssemblyPatternFeature2241 {
    pub fn new() -> BtmAssemblyPatternFeature2241 {
