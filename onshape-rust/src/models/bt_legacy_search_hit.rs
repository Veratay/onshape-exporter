...
pub struct BtLegacySearchHit {
    ...
    #[serde(rename = "hitId", skip_serializing_if = "Option::is_none")]
    ...
    pub r#type: Option<models::BtSearchEntityType>,
}

impl BtLegacySearchHit {
    pub fn new() -> BtLegacySearchHit {
        BtLegacySearchHit {
            document_id: None,
