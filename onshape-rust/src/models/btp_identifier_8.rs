...
pub struct BtpIdentifier8 {
    ...
    #[serde(rename = "invalidIdentifierForTest", skip_serializing_if = "Option::is_none")]
    pub invalid_identifier_for_test: Option<String>,
}

impl BtpIdentifier8 {
    pub fn new() -> BtpIdentifier8 {
        BtpIdentifier8 {
            bt_type: None,
            atomic: None,
            ...
            identifier: None,
            invalid_identifier_for_test: None,
        }
    }
}
