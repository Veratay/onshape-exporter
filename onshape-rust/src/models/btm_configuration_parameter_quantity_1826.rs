...
pub struct BtmConfigurationParameterQuantity1826 {
    /// Type of JSON object.
    ...
    #[serde(rename = "rangeAndDefault", skip_serializing_if = "Option::is_none")]
    pub range_and_default: Option<Box<models::BtQuantityRange181>>,
}

impl BtmConfigurationParameterQuantity1826 {
    pub fn new() -> BtmConfigurationParameterQuantity1826 {
