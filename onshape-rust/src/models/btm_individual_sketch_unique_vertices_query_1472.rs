...
pub struct BtmIndividualSketchUniqueVerticesQuery1472 {
    /// Type of JSON object.
...
impl BtmIndividualSketchUniqueVerticesQuery1472 {
    pub fn new() -> BtmIndividualSketchUniqueVerticesQuery1472 {
