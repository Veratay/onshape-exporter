...
pub struct BtmIndividualCoEdgeQuery1332 {
    /// Type of JSON object.
    ...
    #[serde(rename = "edgeQuery", skip_serializing_if = "Option::is_none")]
    pub edge_query: Option<Box<models::BtmIndividualQuery138>>,
    #[serde(rename = "faceQuery", skip_serializing_if = "Option::is_none")]
    pub face_query: Option<Box<models::BtmIndividualQuery138>>,
}

impl BtmIndividualCoEdgeQuery1332 {
    pub fn new() -> BtmIndividualCoEdgeQuery1332 {
