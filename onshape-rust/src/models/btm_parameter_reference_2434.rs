...
#[serde(tag = "btType")]
pub enum BtmParameterReference2434 {
    #[serde(rename="BTMParameterReferenceBlob-3281")]
    ...
    #[serde(rename="BTMParameterReferenceWithConfiguration-3028")]
...
impl Default for BtmParameterReference2434 {
    fn default() -> Self {
        Self::BtmParameterReferenceBlob3281 {
