...
pub struct BtGlobalTreeNodeListResponseBtTeamInfo {
    ...
    pub items: Option<Box<Vec<models::BtTeamInfo>>>,
...
impl BtGlobalTreeNodeListResponseBtTeamInfo {
    pub fn new() -> BtGlobalTreeNodeListResponseBtTeamInfo {
