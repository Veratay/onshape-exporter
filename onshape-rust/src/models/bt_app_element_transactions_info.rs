...
pub struct BtAppElementTransactionsInfo {
    #[serde(rename = "elementTransactions", skip_serializing_if = "Option::is_none")]
    pub element_transactions: Option<Vec<models::BtElementTransaction>>,
...
impl BtAppElementTransactionsInfo {
    pub fn new() -> BtAppElementTransactionsInfo {
        BtAppElementTransactionsInfo {
            element_transactions: None,
            error_code: None,
