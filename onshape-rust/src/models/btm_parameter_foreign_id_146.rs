...
pub struct BtmParameterForeignId146 {
    /// Type of JSON object.
    ...
    #[serde(rename = "foreignName", skip_serializing_if = "Option::is_none")]
    pub foreign_name: Option<String>,
    #[serde(rename = "locationInfo", skip_serializing_if = "Option::is_none")]
    pub location_info: Option<Box<models::BtForeignDataResponse1070>>,
}

impl BtmParameterForeignId146 {
    pub fn new() -> BtmParameterForeignId146 {
