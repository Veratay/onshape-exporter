...
pub struct BtOccurrenceDisplayData95 {
    /// Type of JSON object.
    ...
    #[serde(rename = "isPatternDescendant", skip_serializing_if = "Option::is_none")]
    pub is_pattern_descendant: Option<bool>,
    #[serde(rename = "occurrenceData", skip_serializing_if = "Option::is_none")]
    pub occurrence_data: Option<Box<models::BtOccurrenceData75>>,
...
impl BtOccurrenceDisplayData95 {
    pub fn new() -> BtOccurrenceDisplayData95 {
