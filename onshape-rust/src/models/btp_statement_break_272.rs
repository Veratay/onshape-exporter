...
pub struct BtpStatementBreak272 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterBreak", skip_serializing_if = "Option::is_none")]
    pub space_after_break: Option<Box<models::BtpSpace10>>,
}

impl BtpStatementBreak272 {
    pub fn new() -> BtpStatementBreak272 {
