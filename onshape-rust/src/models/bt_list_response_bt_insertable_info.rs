...
/// BtListResponseBtInsertableInfo : A list of resources that typically supports paging.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BtListResponseBtInsertableInfo {
...
impl BtListResponseBtInsertableInfo {
    /// A list of resources that typically supports paging.
    pub fn new() -> BtListResponseBtInsertableInfo {
