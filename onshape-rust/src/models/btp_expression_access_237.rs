...
pub struct BtpExpressionAccess237 {
    /// Type of JSON object.
    ...
    pub accessor: Option<Box<models::BtpPropertyAccessor23>>,
    #[serde(rename = "base", skip_serializing_if = "Option::is_none")]
    pub base: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "isSafeNavigation", skip_serializing_if = "Option::is_none")]
    pub is_safe_navigation: Option<bool>,
    #[serde(rename = "spaceInAccessor", skip_serializing_if = "Option::is_none")]
    pub space_in_accessor: Option<Box<models::BtpSpace10>>,
}

impl BtpExpressionAccess237 {
    pub fn new() -> BtpExpressionAccess237 {
        BtpExpressionAccess237 {
            ...
            accessor: None,
            base: None,
            is_safe_navigation: None,
            space_in_accessor: None,
        }
    }
}
