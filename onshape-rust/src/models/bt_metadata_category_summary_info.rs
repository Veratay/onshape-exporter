...
pub struct BtMetadataCategorySummaryInfo {
    #[serde(rename = "defaultObjectType", skip_serializing_if = "Option::is_none")]
    pub default_object_type: Option<i32>,
...
impl BtMetadataCategorySummaryInfo {
    pub fn new() -> BtMetadataCategorySummaryInfo {
