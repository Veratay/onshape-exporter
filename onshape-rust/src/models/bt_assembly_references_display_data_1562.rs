...
pub struct BtAssemblyReferencesDisplayData1562 {
    ...
    #[serde(rename = "assemblyReferences", skip_serializing_if = "Option::is_none")]
    pub assembly_references: Option<Vec<models::BtSingleReferenceDisplayData1943>>,
    /// Type of JSON object.
...
impl BtAssemblyReferencesDisplayData1562 {
    pub fn new() -> BtAssemblyReferencesDisplayData1562 {
        BtAssemblyReferencesDisplayData1562 {
            annotations_for_element: None,
            assembly_references: None,
            bt_type: None,
            element_id: None,
