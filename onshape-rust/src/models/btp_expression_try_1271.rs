...
pub struct BtpExpressionTry1271 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterSilent", skip_serializing_if = "Option::is_none")]
    pub space_after_silent: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "spaceAfterTry", skip_serializing_if = "Option::is_none")]
    pub space_after_try: Option<Box<models::BtpSpace10>>,
}

impl BtpExpressionTry1271 {
    pub fn new() -> BtpExpressionTry1271 {
        BtpExpressionTry1271 {
            ...
            expression: None,
            silent: None,
            space_after_silent: None,
            space_after_try: None,
        }
    }
}
