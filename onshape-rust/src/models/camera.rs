...
pub struct Camera {
    ...
    #[serde(rename = "orthographic", skip_serializing_if = "Option::is_none")]
    pub orthographic: Option<Box<models::CameraOrthographic>>,
    #[serde(rename = "perspective", skip_serializing_if = "Option::is_none")]
    pub perspective: Option<Box<models::CameraPerspective>>,
