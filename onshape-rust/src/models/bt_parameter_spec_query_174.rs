...
pub struct BtParameterSpecQuery174 {
    /// Type of JSON object.
    ...
    #[serde(rename = "additionalBoxSelectFilter", skip_serializing_if = "Option::is_none")]
    pub additional_box_select_filter: Option<Box<models::BtQueryFilter183>>,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<Box<models::BtQueryFilter183>>,
    #[serde(rename = "maxNumberOfPicks", skip_serializing_if = "Option::is_none")]
    pub max_number_of_picks: Option<i32>,
}

impl BtParameterSpecQuery174 {
    pub fn new() -> BtParameterSpecQuery174 {
        BtParameterSpecQuery174 {
            ...
            additional_box_select_filter: None,
            filter: None,
