...
pub enum BtGlobalTreeNodeInfo {
    ...
    #[serde(rename="cloudstorageaccount")]
    ...
    #[serde(rename="external-connection")]
...
impl Default for BtGlobalTreeNodeInfo {
    fn default() -> Self {
        Self::BtClassroomInfo {
