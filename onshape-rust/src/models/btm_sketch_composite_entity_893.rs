...
pub struct BtmSketchCompositeEntity893 {
    /// Type of JSON object.
    ...
    #[serde(rename = "subEntities", skip_serializing_if = "Option::is_none")]
    pub sub_entities: Option<Vec<models::BtmSketchEntity3>>,
}

impl BtmSketchCompositeEntity893 {
    pub fn new() -> BtmSketchCompositeEntity893 {
