...
#[serde(tag = "btType")]
pub enum BtInstance642 {
    #[serde(rename="BTAssemblyInstance-947")]
    BtAssemblyInstance947 {
        ...
        element_reference: Option<Box<models::BtElementReference725>>,
        ...
        locked_state: Option<Box<models::BtmParameter1>>,
        ...
        node_with_reference_list: Option<Vec<models::BtNodeWithReference>>,
        #[serde(rename = "parameters", skip_serializing_if = "Option::is_none")]
        parameters: Option<Vec<models::BtmParameter1>>,
        #[serde(rename = "referenceParameter", skip_serializing_if = "Option::is_none")]
        reference_parameter: Option<Box<models::BtmParameterReferenceWithConfiguration3028>>,
        #[serde(rename = "versionId", skip_serializing_if = "Option::is_none")]
        version_id: Option<String>,
        #[serde(rename = "versionIdIfExternal", skip_serializing_if = "Option::is_none")]
        version_id_if_external: Option<String>,
    },
    #[serde(rename="BTPartInstance-81")]
    BtPartInstance81 {
        /// Microversion that resulted from the import.
        #[serde(rename = "importMicroversion", skip_serializing_if = "Option::is_none")]
        import_microversion: Option<String>,
...
impl Default for BtInstance642 {
    fn default() -> Self {
        Self::BtAssemblyInstance947 {
            ...
            element_reference: Default::default(),
            ...
            node_with_reference_list: Default::default(),
            parameters: Default::default(),
            reference_parameter: Default::default(),
            version_id: Default::default(),
            version_id_if_external: Default::default(),
        }
