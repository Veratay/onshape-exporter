...
pub struct BtpExpressionNew243 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterBox", skip_serializing_if = "Option::is_none")]
    pub space_after_box: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "spaceBetweenNewBox", skip_serializing_if = "Option::is_none")]
    pub space_between_new_box: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::BtpExpression9>>,
}

impl BtpExpressionNew243 {
    pub fn new() -> BtpExpressionNew243 {
        BtpExpressionNew243 {
            bt_type: None,
            atomic: None,
            ...
            space_after_box: None,
            space_between_new_box: None,
            value: None,
        }
    }
}
