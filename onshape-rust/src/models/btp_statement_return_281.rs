...
pub struct BtpStatementReturn281 {
    /// Type of JSON object.
    ...
    #[serde(rename = "spaceAfterReturn", skip_serializing_if = "Option::is_none")]
    pub space_after_return: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::BtpExpression9>>,
}

impl BtpStatementReturn281 {
    pub fn new() -> BtpStatementReturn281 {
