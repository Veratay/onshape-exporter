...
pub struct BtFeatureDefinitionResponse1617 {
    /// Type of JSON object.
    ...
    pub feature: Option<Box<models::BtmFeature134>>,
    #[serde(rename = "featureState", skip_serializing_if = "Option::is_none")]
    pub feature_state: Option<Box<models::BtFeatureState1688>>,
...
impl BtFeatureDefinitionResponse1617 {
    pub fn new() -> BtFeatureDefinitionResponse1617 {
