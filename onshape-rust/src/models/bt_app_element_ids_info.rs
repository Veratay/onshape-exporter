...
pub struct BtAppElementIdsInfo {
    ...
    #[serde(rename = "subelementIds", skip_serializing_if = "Option::is_none")]
    pub subelement_ids: Option<Vec<String>>,
}

impl BtAppElementIdsInfo {
    pub fn new() -> BtAppElementIdsInfo {
        BtAppElementIdsInfo {
            change_id: None,
            error_code: None,
