...
pub struct BtpTopLevelImport285 {
    /// Type of JSON object.
    ...
    #[serde(rename = "combinedNamespacePathAndVersion", skip_serializing_if = "Option::is_none")]
    pub combined_namespace_path_and_version: Option<String>,
    ...
    #[serde(rename = "namespaceString", skip_serializing_if = "Option::is_none")]
    pub namespace_string: Option<String>,
    #[serde(rename = "spaceBeforeImport", skip_serializing_if = "Option::is_none")]
    pub space_before_import: Option<Box<models::BtpSpace10>>,
}

impl BtpTopLevelImport285 {
    pub fn new() -> BtpTopLevelImport285 {
        BtpTopLevelImport285 {
            ...
            symbol_name: None,
            combined_namespace_path_and_version: None,
            import_microversion: None,
            module_id: None,
            namespace: None,
            namespace_string: None,
            space_before_import: None,
        }
    }
}
