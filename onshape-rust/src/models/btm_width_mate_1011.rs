...
pub struct BtmWidthMate1011 {
    ...
    #[serde(rename = "mateConnectorsNotUsedInQuery", skip_serializing_if = "Option::is_none")]
    pub mate_connectors_not_used_in_query: Option<Vec<models::BtmMateConnector66>>,
    #[serde(rename = "tabMateConnectorQueryList", skip_serializing_if = "Option::is_none")]
    pub tab_mate_connector_query_list: Option<Box<models::BtmParameterQueryWithOccurrenceList67>>,
    #[serde(rename = "widthMateConnectorQueryList", skip_serializing_if = "Option::is_none")]
    pub width_mate_connector_query_list: Option<Box<models::BtmParameterQueryWithOccurrenceList67>>,
}

impl BtmWidthMate1011 {
    pub fn new() -> BtmWidthMate1011 {
        BtmWidthMate1011 {
            bt_type: None,
            feature_id: None,
            feature_type: None,
            ...
            version: None,
            mate_connectors_not_used_in_query: None,
            tab_mate_connector_query_list: None,
            width_mate_connector_query_list: None,
        }
    }
}
