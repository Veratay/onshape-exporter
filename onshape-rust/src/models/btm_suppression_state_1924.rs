...
#[serde(tag = "btType")]
pub enum BtmSuppressionState1924 {
    #[serde(rename="BTMSuppressionStateConfigured-2598")]
...
impl Default for BtmSuppressionState1924 {
    fn default() -> Self {
        Self::BtmSuppressionStateConfigured2598 {
