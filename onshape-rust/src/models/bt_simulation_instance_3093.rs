...
pub struct BtSimulationInstance3093 {
    /// Type of JSON object.
    ...
    #[serde(rename = "isModal", skip_serializing_if = "Option::is_none")]
    pub is_modal: Option<bool>,
    #[serde(rename = "simulationId", skip_serializing_if = "Option::is_none")]
    pub simulation_id: Option<String>,
}

impl BtSimulationInstance3093 {
    pub fn new() -> BtSimulationInstance3093 {
