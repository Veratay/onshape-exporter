...
pub struct BtPartMetadataSource2895 {
    /// Type of JSON object.
    ...
    pub source_type: Option<models::GbtMetadataSourceType>,
}

impl BtPartMetadataSource2895 {
    pub fn new() -> BtPartMetadataSource2895 {
