...
#[serde(tag = "btType")]
pub enum BtmIndividualQueryWithOccurrence811 {
    #[serde(rename="BTMInferenceQueryWithOccurrence-1083")]
...
impl Default for BtmIndividualQueryWithOccurrence811 {
    fn default() -> Self {
        Self::BtmInferenceQueryWithOccurrence1083 {
