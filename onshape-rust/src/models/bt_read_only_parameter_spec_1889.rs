...
#[serde(tag = "btType")]
pub enum BtReadOnlyParameterSpec1889 {
    #[serde(rename="BTParameterSpecIcon-4779")]
    ...
    #[serde(rename="BTParameterSpecNotice-3132")]
    ...
    #[serde(rename="BTParameterSpecProgress-3078")]
    ...
    #[serde(rename="BTParameterSpecStringWithTolerances-2535")]
...
impl Default for BtReadOnlyParameterSpec1889 {
    fn default() -> Self {
        Self::BtParameterSpecIcon4779 {
