...
pub struct BtDerivedAssemblyMirror4204 {
    /// Type of JSON object.
    ...
    pub mirror_feature: Option<Box<models::BtmDerivedAssemblyMirrorFeature5094>>,
...
impl BtDerivedAssemblyMirror4204 {
    pub fn new() -> BtDerivedAssemblyMirror4204 {
