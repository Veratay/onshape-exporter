...
#[serde(tag = "btType")]
pub enum BtpFunctionOrPredicateDeclaration247 {
    #[serde(rename="BTPFunctionDeclaration-246")]
    ...
    #[serde(rename="BTPPredicateDeclaration-265")]
...
impl Default for BtpFunctionOrPredicateDeclaration247 {
    fn default() -> Self {
        Self::BtpFunctionDeclaration246 {
