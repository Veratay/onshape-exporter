...
#[serde(tag = "btType")]
pub enum BtQuantityRange181 {
    #[serde(rename="BTNullableQuantityRange-1340")]
    BtNullableQuantityRange1340 {
        #[serde(rename = "defaultValue", skip_serializing_if = "Option::is_none")]
        default_value: Option<f64>,
        #[serde(rename = "location", skip_serializing_if = "Option::is_none")]
        location: Option<Box<models::BtLocationInfo226>>,
...
impl Default for BtQuantityRange181 {
    fn default() -> Self {
        Self::BtNullableQuantityRange1340 {
