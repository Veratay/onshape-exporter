...
pub struct BtmParameterQueryList148 {
    /// Type of JSON object.
    ...
    pub queries: Option<Vec<models::BtmIndividualQueryBase139>>,
}

impl BtmParameterQueryList148 {
    pub fn new() -> BtmParameterQueryList148 {
