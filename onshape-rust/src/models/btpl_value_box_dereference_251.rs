...
pub struct BtplValueBoxDereference251 {
    /// Type of JSON object.
    ...
    pub r#box: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "spaceInside", skip_serializing_if = "Option::is_none")]
    pub space_inside: Option<Box<models::BtpSpace10>>,
}

impl BtplValueBoxDereference251 {
    pub fn new() -> BtplValueBoxDereference251 {
