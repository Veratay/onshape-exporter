...
pub struct BtWorkflowAuditLogInfo {
    ...
    pub entries: Option<Vec<models::BtWorkflowAuditLogEntryInfo>>,
    #[serde(rename = "objectId", skip_serializing_if = "Option::is_none")]
    pub object_id: Option<String>,
    #[serde(rename = "objectType", skip_serializing_if = "Option::is_none")]
    pub object_type: Option<i32>,
    #[serde(rename = "publishedWorkflowId", skip_serializing_if = "Option::is_none")]
    pub published_workflow_id: Option<Box<models::BtPublishedWorkflowId>>,
}

impl BtWorkflowAuditLogInfo {
    pub fn new() -> BtWorkflowAuditLogInfo {
