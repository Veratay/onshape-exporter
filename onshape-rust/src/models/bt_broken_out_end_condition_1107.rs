...
pub struct BtBrokenOutEndCondition1107 {
    /// Type of JSON object.
    ...
    pub upto_point3d: Option<Box<models::BtVector3d389>>,
}

impl BtBrokenOutEndCondition1107 {
    pub fn new() -> BtBrokenOutEndCondition1107 {
