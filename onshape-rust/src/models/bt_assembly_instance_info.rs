...
pub struct BtAssemblyInstanceInfo {
    ...
    pub status: Option<models::BtAssemblyInstanceStatus>,
    #[serde(rename = "suppressed", skip_serializing_if = "Option::is_none")]
    pub suppressed: Option<bool>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<models::BtAssemblyInstanceType>,
}

impl BtAssemblyInstanceInfo {
    /// List of instances including those created by patterns and replicates.
    pub fn new() -> BtAssemblyInstanceInfo {
