...
#[serde(tag = "btType")]
pub enum BtpTopLevelTypeDeclaration287 {
    #[serde(rename="BTPTopLevelEnumDeclaration-284")]
    BtpTopLevelEnumDeclaration284 {
        ...
        name: Option<Box<models::BtpIdentifier8>>,
        #[serde(rename = "spaceAfterVersion", skip_serializing_if = "Option::is_none")]
        space_after_version: Option<Box<models::BtpSpace10>>,
        #[serde(rename = "version", skip_serializing_if = "Option::is_none")]
        version: Option<Box<models::BtpLiteralNumber258>>,
    },
    #[serde(rename="BTPTopLevelUserTypeDeclaration-288")]
...
impl Default for BtpTopLevelTypeDeclaration287 {
    fn default() -> Self {
        Self::BtpTopLevelEnumDeclaration284 {
            ...
            space_after_version: Default::default(),
