...
pub struct BtParameterSpecLookupTablePath761 {
    /// Type of JSON object.
    ...
    #[serde(rename = "lookupTable", skip_serializing_if = "Option::is_none")]
    pub lookup_table: Option<Box<models::BtParameterLookupTableListEntry1916>>,
}

impl BtParameterSpecLookupTablePath761 {
    pub fn new() -> BtParameterSpecLookupTablePath761 {
