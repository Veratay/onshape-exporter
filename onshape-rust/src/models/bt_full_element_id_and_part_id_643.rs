...
pub struct BtFullElementIdAndPartId643 {
    /// Type of JSON object.
    ...
    pub target: Option<Box<models::BtMicroversionIdAndConfiguration2338>>,
    #[serde(rename = "partId", skip_serializing_if = "Option::is_none")]
    pub part_id: Option<String>,
}

impl BtFullElementIdAndPartId643 {
    pub fn new() -> BtFullElementIdAndPartId643 {
