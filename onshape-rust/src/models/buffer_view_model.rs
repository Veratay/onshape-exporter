...
pub struct BufferViewModel {
    #[serde(rename = "bufferModel", skip_serializing_if = "Option::is_none")]
    pub buffer_model: Option<Box<models::BufferModel>>,
    #[serde(rename = "bufferViewData", skip_serializing_if = "Option::is_none")]
    pub buffer_view_data: Option<Box<models::BufferModelBufferData>>,
...
impl BufferViewModel {
    pub fn new() -> BufferViewModel {
        BufferViewModel {
            buffer_model: None,
            buffer_view_data: None,
            byte_length: None,
            byte_offset: None,
            byte_stride: None,
            name: None,
