...
pub struct BtpExpressionAs238 {
    ...
    pub operand: Option<Box<models::BtpExpression9>>,
    #[serde(rename = "typeName", skip_serializing_if = "Option::is_none")]
    pub type_name: Option<Box<models::BtpTypeName290>>,
}

impl BtpExpressionAs238 {
    pub fn new() -> BtpExpressionAs238 {
        BtpExpressionAs238 {
            bt_type: None,
            atomic: None,
