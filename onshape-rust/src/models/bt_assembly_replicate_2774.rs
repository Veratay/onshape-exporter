...
pub struct BtAssemblyReplicate2774 {
    /// Type of JSON object.
    ...
    #[serde(rename = "replicateFeature", skip_serializing_if = "Option::is_none")]
    pub replicate_feature: Option<Box<models::BtmAssemblyReplicateFeature1351>>,
}

impl BtAssemblyReplicate2774 {
    pub fn new() -> BtAssemblyReplicate2774 {
