...
pub struct BtPartStudioDisplayDataReference4360 {
    /// Type of JSON object.
    ...
    #[serde(rename = "cacheDataPath", skip_serializing_if = "Option::is_none")]
    pub cache_data_path: Option<Box<models::BtCacheDataPath191>>,
    #[serde(rename = "tessellationSettings", skip_serializing_if = "Option::is_none")]
    pub tessellation_settings: Option<std::collections::HashMap<String, Vec<i32>>>,
}

impl BtPartStudioDisplayDataReference4360 {
    pub fn new() -> BtPartStudioDisplayDataReference4360 {
