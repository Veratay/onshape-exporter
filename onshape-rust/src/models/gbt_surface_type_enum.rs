...
impl std::fmt::Display for GbtSurfaceTypeEnum {
...
impl Default for GbtSurfaceTypeEnum {
    fn default() -> GbtSurfaceTypeEnum {
        Self::Plane
    }
}
