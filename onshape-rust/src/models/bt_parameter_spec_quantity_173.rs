...
pub struct BtParameterSpecQuantity173 {
    /// Type of JSON object.
    ...
    pub ranges: Option<Vec<models::BtQuantityRange181>>,
}

impl BtParameterSpecQuantity173 {
    pub fn new() -> BtParameterSpecQuantity173 {
