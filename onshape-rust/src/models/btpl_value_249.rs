...
#[serde(tag = "btType")]
pub enum BtplValue249 {
    #[serde(rename="BTPLValueAccess-250")]
    BtplValueAccess250 {
    ...
    #[serde(rename="BTPLValueBoxDereference-251")]
    ...
    #[serde(rename="BTPLValueVarReference-252")]
...
impl Default for BtplValue249 {
    fn default() -> Self {
        Self::BtplValueAccess250 {
