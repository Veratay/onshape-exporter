...
pub struct BtAppElementParams {
    ...
    #[serde(rename = "jsonTree", skip_serializing_if = "Option::is_none")]
    pub json_tree: Option<serde_json::Value>,
    ...
    pub subelements: Option<Vec<models::BtAppElementChangeParams>>,
}

impl BtAppElementParams {
    pub fn new(format_id: String) -> BtAppElementParams {
        BtAppElementParams {
            description: None,
            format_id,
            json_tree: None,
