...
pub struct BtTaskTeamSummaryInfo {
    ...
    pub predefined_team_mutable: Option<bool>,
...
impl BtTaskTeamSummaryInfo {
    pub fn new() -> BtTaskTeamSummaryInfo {
