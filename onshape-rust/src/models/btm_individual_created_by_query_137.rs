...
pub struct BtmIndividualCreatedByQuery137 {
    /// Type of JSON object.
    ...
    pub entity_type: Option<models::GbtEntityType>,
    #[serde(rename = "featureId", skip_serializing_if = "Option::is_none")]
    pub feature_id: Option<String>,
    #[serde(rename = "filterConstruction", skip_serializing_if = "Option::is_none")]
    pub filter_construction: Option<bool>,
}

impl BtmIndividualCreatedByQuery137 {
    pub fn new() -> BtmIndividualCreatedByQuery137 {
