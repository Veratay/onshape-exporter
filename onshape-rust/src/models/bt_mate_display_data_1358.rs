...
pub struct BtMateDisplayData1358 {
    /// Type of JSON object.
    ...
    #[serde(rename = "mateConnectorIds", skip_serializing_if = "Option::is_none")]
    pub mate_connector_ids: Option<Vec<String>>,
...
impl BtMateDisplayData1358 {
    pub fn new() -> BtMateDisplayData1358 {
        BtMateDisplayData1358 {
            bt_type: None,
            hidden: None,
            is_derived_feature: None,
            mate_connector_ids: None,
            mate_type: None,
            node_id: None,
