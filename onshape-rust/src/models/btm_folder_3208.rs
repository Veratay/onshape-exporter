...
pub struct BtmFolder3208 {
    ...
    #[serde(rename = "isStartFolder", skip_serializing_if = "Option::is_none")]
    pub is_start_folder: Option<bool>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}

impl BtmFolder3208 {
    pub fn new() -> BtmFolder3208 {
        BtmFolder3208 {
            bt_type: None,
            import_microversion: None,
            node_id: None,
            folder_id: None,
            is_start_folder: None,
            name: None,
        }
    }
}
