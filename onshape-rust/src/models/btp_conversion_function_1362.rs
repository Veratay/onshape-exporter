...
pub struct BtpConversionFunction1362 {
    /// Type of JSON object.
    ...
    pub from: Option<Box<models::BtpLiteralNumber258>>,
    #[serde(rename = "spaceAfterType", skip_serializing_if = "Option::is_none")]
    pub space_after_type: Option<Box<models::BtpSpace10>>,
    #[serde(rename = "to", skip_serializing_if = "Option::is_none")]
    pub to: Option<Box<models::BtpLiteralNumber258>>,
    #[serde(rename = "typeName", skip_serializing_if = "Option::is_none")]
    pub type_name: Option<Box<models::BtpIdentifier8>>,
}

impl BtpConversionFunction1362 {
    pub fn new() -> BtpConversionFunction1362 {
