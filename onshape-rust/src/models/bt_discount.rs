...
pub struct BtDiscount {
    ...
    #[serde(rename = "amountOffCurrency", skip_serializing_if = "Option::is_none")]
    pub amount_off_currency: Option<String>,
    ...
    pub id: Option<Box<models::BtDiscountOwnerIdPlanId>>,
