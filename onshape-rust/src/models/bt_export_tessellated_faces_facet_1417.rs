...
pub struct BtExportTessellatedFacesFacet1417 {
    /// Type of JSON object.
    ...
    pub normals: Option<Vec<models::BtVector3d389>>,
    #[serde(rename = "textureCoordinates", skip_serializing_if = "Option::is_none")]
    pub texture_coordinates: Option<Vec<models::BtVector2d1812>>,
    #[serde(rename = "vertices", skip_serializing_if = "Option::is_none")]
    pub vertices: Option<Vec<models::BtVector3d389>>,
}

impl BtExportTessellatedFacesFacet1417 {
    pub fn new() -> BtExportTessellatedFacesFacet1417 {
