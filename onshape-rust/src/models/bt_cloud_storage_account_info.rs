...
pub struct BtCloudStorageAccountInfo {
    ...
    pub export_folder: Option<Box<models::BtCloudStorageObjectInfo>>,
    #[serde(rename = "importFolder", skip_serializing_if = "Option::is_none")]
    pub import_folder: Option<Box<models::BtCloudStorageObjectInfo>>,
    #[serde(rename = "lastAuthenticated", skip_serializing_if = "Option::is_none")]
