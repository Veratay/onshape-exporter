...
#[serde(tag = "btType")]
pub enum BtParameterLookupTableEntry1667 {
    #[serde(rename="BTParameterLookupTableListEntry-1916")]
...
impl Default for BtParameterLookupTableEntry1667 {
    fn default() -> Self {
        Self::BtParameterLookupTableListEntry1916 {
            additional_localized_strings: Default::default(),
            label: Default::default(),
            localizable_name: Default::default(),
            localized_label: Default::default(),
