...
#[serde(tag = "btType")]
pub enum BtmIndividualQueryWithOccurrenceBase904 {
    #[serde(rename="BTMFeatureQueryWithOccurrence-157")]
    ...
    #[serde(rename="BTMIndividualOccurrenceQuery-626")]
    ...
    #[serde(rename="BTMIndividualQueryWithOccurrence-811")]
    ...
    #[serde(rename="BTMMeshPointQuery-1183")]
...
impl Default for BtmIndividualQueryWithOccurrenceBase904 {
    fn default() -> Self {
        Self::BtmFeatureQueryWithOccurrence157 {
